<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <script src="https://use.fontawesome.com/releases/v6.3.0//admin/js/all.js" crossorigin="anonymous"></script>
        ...
        <body class="sb-nav-fixed">
            ...
            <%@ include file="../layout/header.jsp" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card bg-danger text-white mb-4">
                                            <div class="card-body">Số lượng Champion (${countProducts})</div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist//admin/js/bootstrap.bundle.min.js"
                    crossorigin="anonymous"></script>
                <script src="/admin/js/scripts.js"></script>
                <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart./admin/js/2.8.0/Chart.min.js"
                    crossorigin="anonymous"></script>
